...
public class VaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new VaseActivity.GridSpacingItemDecoration(2, dpToPx(10), true));
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    Glide.with(getApplicationContext()).load(R.drawable.vase).into((ImageView) findViewById(R.id.backdrop));
                } catch (Exception e) {
                    e.printStackTrace();
                }
